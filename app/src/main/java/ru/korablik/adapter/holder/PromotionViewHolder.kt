 ...
 */
class PromotionViewHolder(private val ui: PromotionViewHolderUI) : RecyclerView.ViewHolder(ui.root) {

    fun bind(payload: SharesPayload) {
        (ui.viewPager.adapter as PromotionAdapter).apply {
...
class PromotionViewHolderUI : AnkoComponent<ViewGroup> {
...
class PromotionAdapter : PagerAdapter(), InfinitePagerAdapter {
